...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var DOWNLOAD_LINK_MESSAGES={'en':'Download','fr':'Télécharger','de':'Herunterladen','es':'Descargar','ro':'Descărcați','ar':'تنزيل'};
  var DOWNLOAD_TOOLTIP_MESSAGES={'en':'Download this video','fr':'Télécharger cette vidéo','de':'Dieses Video herunterladen','es':'Descargar este vídeo','ro':'Descărcați acest videoclip','ar':'تنزيل هذا الفيديو'};
