...
These are a collection of helper scripts to help with feed enclosure downloading. They were made to work together with [Liferea](https://lzone.de/liferea/) and [uGet](https://ugetdm.com/) so as to try and get the best video quality possible of feed enclosures, and to minimize any required maintenance from the user.
